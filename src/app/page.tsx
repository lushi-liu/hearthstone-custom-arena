...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 text-black pt-16 flex flex-col items-center justify-center">
      <h1 className="text-4xl font-bold mb-4">Welcome to Hearthstone Arena!</h1>
      <p className="text-lg mb-6 text-center max-w-md">
        Draft your ultimate TGT-era deck with 3 random class choices and a
        strategic mana curve.
      </p>
      <Link
        href="/draft-deck"
